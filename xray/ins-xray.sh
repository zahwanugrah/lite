...
wget -q -O /usr/bin/del-vless "https://raw.githubusercontent.com/rullpqh/lite/main/xray/del-vless" && chmod +x /usr/bin/del-vless
...
wget -q -O /usr/bin/renew-ws "https://raw.githubusercontent.com/rullpqh/lite/main/xray/cek-tr.sh" && chmod +x /usr/bin/renew-ws
