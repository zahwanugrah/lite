...
# / / info installer
echo ""
echo -e "[ ${green}INFO${NC} ] AUTOSCRIPT LITE (MULTI PORT) "
echo -e "[ ${green}INFO${NC} ] hubungkan terlebih dahulu ip vps ke domain anda "
echo -e "[ ${red}INFO${NC} ] pastikan internet kamu lancar di saat install script "
echo -ne "[ ${yell}WARNING${NC} ] LANJUT UNTUK MENGINSTAL SCRIPT (y/n)? "
read answer
if [ "$answer" == "${answer#[Yy]}" ] ;then
rm setup.sh
sleep 10
...
echo ""
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      SCRIPT MULTI PORT               $NC"
echo -e "$green              BY                      $NC"
