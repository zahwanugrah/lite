...
sleep 1
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/rullpqh/autoscript/main/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -q -O /usr/bin/add-vless "https://raw.githubusercontent.com/rullpqh/autoscript/main/xray/add-vless.sh" && chmod +x /usr/bin/add-vless
wget -q -O /usr/bin/add-tr "https://raw.githubusercontent.com/rullpqh/autoscript/main/xray/add-tr.sh" && chmod +x /usr/bin/add-tr
wget -q -O /usr/bin/del-user "https://raw.githubusercontent.com/rullpqh/autoscript/main/xray/del-ws.sh" && chmod +x /usr/bin/del-user
wget -q -O /usr/bin/cek-ws "https://raw.githubusercontent.com/rullpqh/autoscript/main/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
